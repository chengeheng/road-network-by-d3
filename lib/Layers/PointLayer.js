...
var navigation = require('../images/navigation.svg.js');
...
var PointLayer = /** @class */ (function (_super) {
    ...
    function PointLayer(dataSource, option) {
        ...
        _this._imageShrink = option.imageShrink === undefined ? true : option.imageShrink;
        _this.clickCount = 0;
        _this.isHided = false;
        _this.filterIds = [];
        _this._hover = false;
    ...
    PointLayer.prototype._combineOption = function (option) {
        var _a = option.tinyIconStyle, tinyIconStyle = _a === void 0 ? {} : _a, rest = _tslib.__rest(option, ["tinyIconStyle"]);
        var defaultTinyIconStyle = defaultOption.tinyIconStyle, restOption = _tslib.__rest(defaultOption, ["tinyIconStyle"]);
        return _tslib.__assign(_tslib.__assign(_tslib.__assign({}, restOption), rest), { tinyIconStyle: _tslib.__assign(_tslib.__assign({}, defaultTinyIconStyle), tinyIconStyle) });
    };
    PointLayer.prototype._drawWithHoverColor = function () {
        var _this = this;
        var g = this.baseLayer.selectAll("g").data(this._formatData(this.data)).enter().append("g");
        ...
        g.append("image")
            ...
            .attr("transform", function (d) { return "rotate(".concat(d.option.rotate, ", ").concat(d.imageCenter[0], ", ").concat(d.imageCenter[1], ")"); })
    ...
    PointLayer.prototype._formatData = function (data) {
        ...
        return data.map(function (i) {
            ...
            var fontSize = 12;
            var icon = (_c = (_a = i.icon) !== null && _a !== void 0 ? _a : (_b = i.option) === null || _b === void 0 ? void 0 : _b.icon) !== null && _c !== void 0 ? _c : _this.option.icon;
            if (_this._imageShrink === false) {
            ...
            var useTinyIcon = (_e = (_d = i.option) === null || _d === void 0 ? void 0 : _d.useTinyIcon) !== null && _e !== void 0 ? _e : option.useTinyIcon;
            if (useTinyIcon && _this._mapConfig.level > 6) {
                icon = (_g = (_f = i.option) === null || _f === void 0 ? void 0 : _f.tinyIcon) !== null && _g !== void 0 ? _g : option.tinyIcon;
                // rotate = rotate - 143;
            }
            var imageCenter = [
            ...
            return _tslib.__assign(_tslib.__assign({}, i), { coordinate: coordinate, icon: icon, useTinyIcon: useTinyIcon, option: _tslib.__assign(_tslib.__assign({}, option), { width: width, height: height, offset: offset, fontSize: fontSize, onHover: lodash.debounce(function (e) {
                        if (_this._hover) {
                            option.onHover(e);
                        }
    ...
    PointLayer.prototype.init = function (g, projection, config) {
        ...
        this.container = d3__namespace.select(g).append("g").attr("id", "point-layer-".concat(this.makeRandomId()));
