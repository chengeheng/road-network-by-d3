...
var PointLayer = /** @class */ (function (_super) {
    ...
    PointLayer.prototype._formatData = function (data) {
        ...
        return data.map(function (i) {
            ...
            return _tslib.__assign(_tslib.__assign({}, i), { coordinate: coordinate, icon: (_c = (_a = i.icon) !== null && _a !== void 0 ? _a : (_b = i.option) === null || _b === void 0 ? void 0 : _b.icon) !== null && _c !== void 0 ? _c : _this.option.icon, option: _tslib.__assign(_tslib.__assign({}, option), { width: width, height: height, offset: offset, fontSize: fontSize }), imageCenter: imageCenter, imageLeftTop: imageLeftTop });
        });
    };
