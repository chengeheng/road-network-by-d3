...
var PolygonLayer = /** @class */ (function (_super) {
    ...
    PolygonLayer.prototype._draw = function () {
        ...
        var nameGroup = this._baseLayer.append("g").style("pointer-events", "none");
        pathGroup
            .selectAll("path")
            .data(pathData)
            .enter()
            ...
            var index = coordinates.findIndex(function (i) { return d3__namespace.polygonContains(i, targetCoord); });
            var originalParams;
            ...
            var index = d.geometry.coordinates.findIndex(function (i) { return d3__namespace.polygonContains(i, targetCoord); });
            var originalParams;
            if (_this._selectType === "all") {
                originalParams = _this.data;
            }
    ...
    PolygonLayer.prototype.init = function (g, projection, option) {
        ...
        this.container = d3__namespace.select(g).append("g").attr("id", "polygon-layer-".concat(this.makeRandomId()));
