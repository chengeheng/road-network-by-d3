    ...
    PolyLineLayer.prototype._draw = function () {
        ...
        this._baseLayer
            ...
            for (var i = 0; i < coordinates.length; i++) {
                var inPoint = _this._isPointInLine(coordinates[i], d3__namespace.pointer(e, _this.container.node()), _this.projection, d.properties.option.style.strokeWidth)[0];
                if (inPoint) {
                    index = i;
                    break;
                }
            ...
            if (hasHover) {
                ...
                var coordinates = d.geometry.coordinates;
                for (var i = 0; i < coordinates.length; i++) {
                    var _a = _this._isPointInLine(coordinates[i], d3__namespace.pointer(e, _this.container.node()), _this.projection, d.properties.option.style.strokeWidth), inPoint = _a[0], start = _a[1], end = _a[2];
                    if (inPoint) {
                        index = i;
                        startIndex = start;
                        endIndex = end;
