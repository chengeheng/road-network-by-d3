...
var PointLayer = /** @class */ (function (_super) {
    ...
    PointLayer.prototype.draw = function () {
        var _this = this;
        var g = this.baseLayer.selectAll("g").data(this.formatData(this.data)).enter().append("g");
        g.append("image")
        ...
        g.filter(function (i) {
            ...
            .attr("x", function (d) { return d.coordinate[0]; })
            .attr("y", function (d) { return d.coordinate[1]; })
            .attr("transform", function (d) { return "translate(".concat(0, ",").concat(d.option.offset[1], ")"); })
            .attr("font-size", 12)
            .attr("dx", function (d) {
    ...
    PointLayer.prototype.formatData = function (data) {
        ...
        return data.map(function (i) {
            var _a;
            return _tslib.__assign(_tslib.__assign({}, i), { coordinate: _this.projection(i.coordinate), icon: (_a = i.icon) !== null && _a !== void 0 ? _a : _this.option.icon, option: _tslib.__assign(_tslib.__assign({}, _this.option), i.option) });
        });
    };
    PointLayer.prototype.calcuteTextWidth = function (text, fontSize) {
