...
var Map = /** @class */ (function () {
    ...
    Map.prototype.init = function () {
        ...
        svg
            ...
            console.log(d3__namespace.pointer(e, g.node()));
    ...
    Map.prototype.focusOnView = function (coords) {
        ...
        var min = [projectionCoords[0][0], projectionCoords[0][1]];
        var max = [projectionCoords[0][0], projectionCoords[0][1]];
        projectionCoords.forEach(function (i) {
            if (i[0] < min[0]) {
                min[0] = i[0];
            }
            if (i[1] < min[1]) {
